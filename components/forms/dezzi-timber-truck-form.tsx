...
import { CheckCircle2, Send, AlertCircle, Eraser, Info, Skull, AlertTriangle } from "lucide-react"
    ...
    return (
        <div className="mx-auto max-w-5xl space-y-10 pb-20">
            ...
            <form onSubmit={handleSubmit} className="space-y-12 px-4 md:px-0">
                {/* Instructions */}
                <div className="rounded-2xl border-2 border-[#8cc63f]/20 bg-[#f8faf6] p-8 space-y-4">
                ...
                {/* Metadata */}
                <div className="grid gap-6 md:grid-cols-3 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    <div className="space-y-2">
                        ...
                        <Select onValueChange={(v) => setFormData(prev => ({ ...prev, operatorName: v }))}>
                            <SelectTrigger className="h-12 rounded-xl bg-gray-50 border-gray-200"><SelectValue placeholder="Select" /></SelectTrigger>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input type="date" className="h-12 rounded-xl bg-gray-50 border-gray-200" value={formData.date} onChange={(e) => setFormData(prev => ({ ...prev, date: e.target.value }))} />
                    </div>
                    <div className="space-y-2">
                        <Label className="text-xs font-bold text-gray-500 uppercase">Hour Meter Start</Label>
                        <Input className="h-12 rounded-xl bg-gray-50 border-gray-200" onChange={(e) => setFormData(prev => ({ ...prev, hourMeterStart: e.target.value }))} />
                    </div>
                    <div className="space-y-2">
                        <Label className="text-xs font-bold text-gray-500 uppercase">Hour Meter Stop</Label>
                        <Input className="h-12 rounded-xl bg-gray-50 border-gray-200" onChange={(e) => setFormData(prev => ({ ...prev, hourMeterStop: e.target.value }))} />
                    </div>
                    <div className="space-y-2">
                        <Label className="text-xs font-bold text-gray-500 uppercase">Valid Training Card (Exp Date)</Label>
                        <Input type="date" className="h-12 rounded-xl bg-gray-50 border-gray-200" onChange={(e) => setFormData(prev => ({ ...prev, trainingCardExpiry: e.target.value }))} />
                    </div>
                    <div className="space-y-2">
                        <Label className="text-xs font-bold text-gray-500 uppercase">Unit Number</Label>
                        <Input className="h-12 rounded-xl bg-gray-50 border-gray-200" onChange={(e) => setFormData(prev => ({ ...prev, unitNumber: e.target.value }))} />
                    </div>
                    <div className="space-y-2 md:col-span-1">
                        <Label className="text-xs font-bold text-gray-500 uppercase">Valid License & PDP (Exp Date)</Label>
                        <Input type="date" className="h-12 rounded-xl bg-gray-50 border-gray-200" onChange={(e) => setFormData(prev => ({ ...prev, licensePdpExpiry: e.target.value }))} />
                    </div>
                </div>
                ...
                <div className="grid gap-8 md:grid-cols-2 pt-10 border-t border-gray-200">
                    <div className="space-y-2">
                        ...
                        <Select onValueChange={(v) => setFormData(prev => ({ ...prev, areThereAnyDefects: v }))}>
                            <SelectTrigger className="h-12 rounded-xl border-gray-200 bg-white"><SelectValue placeholder="Select" /></SelectTrigger>
                ...
                <div className="space-y-4">
                    ...
                    <Textarea
                        className="min-h-[120px] rounded-2xl border-gray-200 shadow-inner"
                ...
                <div className="flex items-center justify-between py-4">
                    <div className="text-sm font-bold text-gray-900">Automatic Number: {formData.automaticNumber}</div>
                    <Button type="submit" className="bg-[#fbb016] hover:bg-[#e5a014] text-black font-extrabold h-12 px-12 rounded-lg">Submit</Button>
                </div>
            </form>
        </div>
    )
