...
const sections = [
    ...
    },
    {
        ...
        items: ["Fuel and oil levels correct.", "Fuel cap and hydraulic filler cap secure.", "All dipsticks secure."],
    ...
    {
        title: "Fire Systems",
        items: ["Gauge light working/no warning lights.", "No damaged hoses.", "Secured/service/seal in place.", "Gauges in order."],
...
export default function SelfLoadingForwarderForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const submission = {
                formType: "self-loading-forwarder-pre-shift-inspection",
        ...
        return (
            <div className="flex min-h-[60vh] flex-col items-center justify-center space-y-6 text-center animate-in fade-in zoom-in duration-500">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-lg text-gray-500">The Self Loading Forwarder Inspection Checklist has been recorded.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-12 px-4 md:px-0">
                ...
                <div className="flex items-center justify-between py-4">
                    <div className="text-sm font-bold text-gray-900">
                        Automatic Number: {formData.automaticNumber || <span className="text-gray-400 italic font-normal">Generated on Submit</span>}
                    </div>
