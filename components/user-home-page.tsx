...
const forms = [
  ...
  },
  {
    ...
    subtitle: "Inspection Checklist",
    description: "Daily inspection for water cart trailers including tanks, tyres, brakes, and safety equipment.",
    icon: Container,
  ...
  },
  {
    ...
    subtitle: "Checklist",
    description: "Inspection checklist for pressure washers covering engine oil, fuel, hoses, and safety features.",
    icon: Wrench,
  ...
  },
  {
    ...
    subtitle: "Inspection Checklist",
    description: "Complete inspection checklist for diesel cart trailers covering tank, hoses, lights, brakes, and safety equipment.",
    icon: Truck,
  ...
  },
  {
    ...
    title: "Ponsse Bison",
    subtitle: "Pre-Shift Inspection",
    description: "Daily pre-shift inspection for Ponsse Bison forwarders including safety systems, hydraulics, and engine checks.",
    icon: Tractor,
    href: "/ponsse-bison",
    docRef: "HSEMS/8.1.9/REG/014",
    itemCount: 34,
  },
  {
    ...
    subtitle: "Pre-Shift Inspection",
    description: "Daily pre-shift inspection for Self Loading Forwarders covering safety, hydraulics, engine, and structural checks.",
    icon: Tractor,
  ...
  },
  {
    ...
    subtitle: "Pre-Shift Inspection",
    description: "Daily pre-shift inspection for Service and Diesel trucks covering tank, safety systems, hydraulics, and mechanical checks.",
    icon: Truck,
